...
(defn lazywatch
  "Run all of the tests in the lazytest suite, watching source and test directories for updates"
  [project]
  (java ["-cp" "src:test:classes:lib/*:lib/dev/*"] "lazytest.watch" [(str (:source-path project)) (str (:test-path project))] (:root project)))
